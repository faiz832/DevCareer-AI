            ...
            @role('owner|teacher')
                <li>
                    <a href="{{ route('admin.courses.index') }}"
                        class="flex items-center {{ Route::is('admin.courses.index') || Route::is('admin.courses.create') || Route::is('admin.courses.edit') || Route::is('admin.courses.show') ? 'text-blue-500 relative' : 'text-slate-900' }}">
                        @if (Route::is('admin.courses.index') ||
                                Route::is('admin.courses.create') ||
                                Route::is('admin.courses.edit') ||
                                Route::is('admin.courses.show'))
                            <div class="absolute -left-6 h-full w-1 bg-blue-500"></div>
                        @endif
                        <svg class="h-5 w-5 mr-3 {{ Route::is('admin.courses.index') || Route::is('admin.courses.create') || Route::is('admin.courses.edit') || Route::is('admin.courses.show') ? 'text-blue-500' : 'text-slate-900' }}"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
