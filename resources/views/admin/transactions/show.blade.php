                    ...
                    <div class="flex flex-row gap-x-10">
                        ...
                        <div class="flex flex-col gap-y-10">
                            ...
                            <div>
                                ...
                                <h3 class="text-indigo-950 text-xl font-bold">{{$transaction->created_at->format('Y-m-d')}}</h3>
                            </div>
                            <div>
                                <p class="text-slate-500 text-sm">Subscription Start At</p>
                                <h3 class="text-indigo-950 text-xl font-bold">{{$transaction->subscription_start_date->format('Y-m-d')}}</h3>
                            </div>
                            <div class="">
