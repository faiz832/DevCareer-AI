                        ...
                        <div x-data="studentEmailSearch()" x-init="initSelectize" class="flex flex-col space-y-4">
                            <form action="{{ route('admin.teachers.store') }}" method="POST" class="flex gap-2">
                                ...
                                <input type="email" name="email" id="email-search"
                                    ...
                                    placeholder="Search for student email..." required>
                                <button type="submit"
                                            ...
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-10 w-10">
                                                    <img class="h-10 w-10 rounded-full"
                                                        src="{{ Storage::disk('public')->exists($teacher->user->avatar) ? Storage::url($teacher->user->avatar) : asset('assets/images/default-avatar.png') }}"
                                                        alt="">
                                                </div>
                                                <div class="ml-4">
                                        ...
                                        <td class="px-6 py-4 text-center space-x-2">
                                            ...
                                            <form action="{{ route('admin.teachers.destroy', $teacher) }}"
                                                ...
                                                <button type="submit"
                                                    ...
                                                    onclick="return confirm('Are you sure you want to remove this teacher?')">Remove</button>
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
