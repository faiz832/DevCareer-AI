...
<head>
    ...
    <title>Checkout - CodeCareer</title>
                    ...
                    <form action="{{ route('front.checkout.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-4 mb-8">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <span class="font-semibold">PT CodeCareer Indonesia</span>
                            </div>
                        </div>
                        <div class="mb-6">
                            <h3 class="text-xl font-semibold mb-4">Confirm Your Payment</h3>
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center cursor-pointer hover:border-blue-500 transition duration-300">
                                <input type="file" name="proof" id="proof" class="hidden" required onchange="updateFileName(this)">
                                <label for="proof" class="cursor-pointer">
                                    <svg class="w-8 h-8 mx-auto mb-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
